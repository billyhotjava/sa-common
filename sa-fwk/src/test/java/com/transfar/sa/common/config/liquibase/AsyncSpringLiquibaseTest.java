...
package com.transfar.sa.common.config.liquibase;

import com.transfar.sa.common.config.JHipsterConstants;
import com.transfar.sa.common.test.LogbackRecorder;
...
public class AsyncSpringLiquibaseTest {
    ...
    public void testProfileNoLiquibase() {
        environment.setActiveProfiles(JHipsterConstants.SPRING_PROFILE_NO_LIQUIBASE);
    ...
    public void testProfileProduction() {
        ...
        LogbackRecorder.Event event0 = events.get(0);
        ...
        LogbackRecorder.Event event1 = events.get(1);
    ...
    public void testProfileDevelopment() {
        environment.setActiveProfiles(JHipsterConstants.SPRING_PROFILE_DEVELOPMENT);
    ...
    public void testProfileHeroku() {
        environment.setActiveProfiles(JHipsterConstants.SPRING_PROFILE_HEROKU);
    ...
    public void testSlow() {
        environment.setActiveProfiles(JHipsterConstants.SPRING_PROFILE_DEVELOPMENT, JHipsterConstants.SPRING_PROFILE_HEROKU);
        ...
        assertThat(event1.getMessage()).isEqualTo(AsyncSpringLiquibase.STARTED_MESSAGE);
        assertThat(event1.getThrown()).isNull();
        LogbackRecorder.Event event2 = events.get(2);
